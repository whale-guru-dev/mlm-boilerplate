...
<!-- 							</ul>
				...
				<li class="{!! $route->getPrefix() == 'admin/genealogy'? 'active': '' !!}">
					...
					<ul class="sub-menu">
						<li>							
							<a href="{{url('admin/genealogy/matrix')}}"><span class="title">Community Tree</span></a>
						</li>

						<li>							
							<a href="{{url('admin/genealogy/treeview')}}"><span class="title">TreeView Community</span></a>
						</li>
					</ul>
				</li>
