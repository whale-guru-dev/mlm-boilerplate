...
<!-- 				<li class="">
				...
				<li class="{!! $route->getPrefix() == 'member/genealogy'? 'active': '' !!}">
					...
					<ul class="sub-menu">
						<li>							
							...
							<span class="title">Community Tree</span>
							</a>
						</li>

						<li>							
							<a href="{{url('member/genealogy/treeview')}}">
							<span class="title">TreeView Community</span>
							</a>
						</li>
					</ul>
				</li>
				...
				<li class="{!! $route->getPrefix() == 'member/incomecalc'? 'active': '' !!}">
					<a href="javascript:;">
					<i class="icon-calculator"></i>
					<span class="title">Stability Calculations</span>
					<span class="arrow"></span>
					</a>
					<ul class="sub-menu">
						<li>
							<a href="{{url('member/incomecalc/membership')}}">
							<span class="title">Stability Income Totals</span>
							</a>
						</li>
					</ul>
				</li>
